...
echo ""
echo "  Threshold (default 100K tokens):"
echo "    export PRE_USAGE_THRESHOLD=100K   # plain integer, or K / M suffix"
echo "    export PRE_USAGE_THRESHOLD=1M"
echo ""
echo "  Strategy when threshold is exceeded (default: block):"
echo "    export PRE_USAGE_STRATEGY=block   # show [S]end / [C]ancel prompt"
echo "    export PRE_USAGE_STRATEGY=warn    # print warning and auto-proceed"
echo ""
